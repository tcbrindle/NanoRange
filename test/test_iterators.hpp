...
public:
	using difference_type = nanorange::difference_type_t<It>;
	using pointer = It;
	using reference = nanorange::reference_t<It>;
...
public:
	...
	typedef nanorange::value_type_t<It>      value_type;
	typedef nanorange::difference_type_t<It> difference_type;
	typedef It                       pointer;
	typedef nanorange::reference_t<It>  reference;
