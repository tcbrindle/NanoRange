...
void test_rng_3()
{
	int i[3] = {1, 2, 3};
	int j[3] = {4, 5, 6};
	std::pair<Iter1, Iter2> r = stl2::swap_ranges(as_lvalue(stl2::make_range(Iter1(i), Iter1(i+3))), Iter2(j));
	CHECK(base(r.first) == i+3);
	CHECK(base(r.second) == j+3);
	CHECK(i[0] == 4);
	CHECK(i[1] == 5);
	...
	using Sent1 = typename sentinel_type<Iter1>::type;
	r = stl2::swap_ranges(as_lvalue(stl2::make_range(Iter1(j), Sent1(j+3))), Iter2(i));
	CHECK(base(r.first) == j+3);
	CHECK(base(r.second) == i+3);
	CHECK(i[0] == 1);
	CHECK(i[1] == 2);
...
void test_rng_4()
{
	...
	std::pair<Iter1, Iter2> r = stl2::swap_ranges(
		as_lvalue(stl2::make_range(Iter1(i), Iter1(i+3))),
		as_lvalue(stl2::make_range(Iter2(j), Iter2(j+4))));
	CHECK(base(r.first) == i+3);
	CHECK(base(r.second) == j+3);
	CHECK(i[0] == 4);
	CHECK(i[1] == 5);
	...
	using Sent2 = typename sentinel_type<Iter2>::type;
	r = stl2::swap_ranges(
		as_lvalue(stl2::make_range(Iter1(j), Sent1(j+4))),
		as_lvalue(stl2::make_range(Iter2(i), Sent2(i+3))));
	CHECK(base(r.first) == j+3);
	CHECK(base(r.second) == i+3);
	CHECK(i[0] == 1);
	CHECK(i[1] == 2);
	...
	auto r2 = stl2::swap_ranges(
		stl2::make_range(Iter1(j), Sent1(j+4)),
		stl2::make_range(Iter2(i), Sent2(i+3)));
