...
public:
    ...
    template <typename U>
    constexpr detail::enable_if_t<ConvertibleTo<U, I>, move_iterator&>
    ...
    constexpr auto operator++(int) -> detail::enable_if_t<!ForwardIterator<II>>
    {
        ++current_;
    }
    ...
    constexpr auto operator++(int)
        -> detail::enable_if_t<ForwardIterator<II>, move_iterator>
    {
    ...
    constexpr auto operator--()
        -> detail::enable_if_t<BidirectionalIterator<II>, move_iterator&>
    {
        --current_;
        return *this;
    }
    ...
    constexpr auto operator+(difference_type n) const
        -> detail::enable_if_t<RandomAccessIterator<II>, move_iterator>
    {
    ...
    template <typename II = I>
    constexpr auto operator[](difference_type n) const
        -> detail::enable_if_t<RandomAccessIterator<II>, reference>
    //   -> decltype(auto)
    {
...
constexpr auto operator==(const move_iterator<I1>& x,
    ...
    -> detail::enable_if_t<EqualityComparableWith<I1, I2>, bool>
{
...
constexpr auto operator<(const move_iterator<I1>& x, const move_iterator<I2>& y)
    -> detail::enable_if_t<StrictTotallyOrderedWith<I1, I2>, bool>
{
    return x.base() < y.base();
}
...
template <typename I1, typename I2>
constexpr auto operator-(const move_iterator<I1>& x, const move_iterator<I2>& y)
    -> detail::enable_if_t<SizedSentinel<I1, I2>, iter_difference_t<I2>>
{
    return x.base() - y.base();
}
...
constexpr auto operator+(iter_difference_t<I> n, const move_iterator<I>& x)
    -> detail::enable_if_t<RandomAccessIterator<I>, move_iterator<I>>
{
    return x + n;
}
...
constexpr auto make_move_iterator(I i)
    -> detail::enable_if_t<InputIterator<I>, move_iterator<I>>
{
...
public:
    ...
    template <typename U, detail::enable_if_t<ConvertibleTo<U, S>, int> = 0>
    constexpr move_sentinel(const move_sentinel<U>& s) : last_(s.base())
    {}

    template <typename U>
    constexpr auto operator=(const move_sentinel<U>& s)
        -> detail::enable_if_t<ConvertibleTo<U, S>, move_sentinel&>
    {
        last_ = s.base();
        return *this;
    }
...
constexpr auto operator==(const move_iterator<I>& i, const move_sentinel<S>& s)
    -> detail::enable_if_t<Sentinel<S, I>, bool>
{
...
template <typename I, typename S>
constexpr auto operator-(const move_sentinel<S>& s, const move_iterator<I>& i)
    -> detail::enable_if_t<SizedSentinel<S, I>, iter_difference_t<I>>
{
...
constexpr auto make_move_sentinel(S s)
    -> detail::enable_if_t<Semiregular<S>, move_sentinel<S>>
{
