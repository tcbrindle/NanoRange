...
private:
    ...
    static constexpr auto impl(R& r, iter_difference_t<R> n)
        -> detail::enable_if_t<RandomAccessIterator<R>>
    {
        r += n;
    }
    ...
    static constexpr auto impl(I& i, iter_difference_t<I> n)
        -> detail::enable_if_t<BidirectionalIterator<I> &&
    ...
    static constexpr auto impl(I& i, S bound, priority_tag<2>)
        -> detail::enable_if_t<Assignable<I&, S>>
    {
        i = std::move(bound);
    }
    ...
    static constexpr auto impl(I& i, S bound, priority_tag<1>)
        -> detail::enable_if_t<SizedSentinel<S, I>>
    {
        fn::impl(i, bound - i);
    }
    ...
    template <typename I, typename S>
    static constexpr auto impl(I& i, iter_difference_t<I> n, S bound)
        -> detail::enable_if_t<BidirectionalIterator<I> && !SizedSentinel<S, I>,
                            iter_difference_t<I>>
    {
...
public:
    ...
    constexpr auto operator()(I& i, iter_difference_t<I> n, S bound) const
        -> detail::enable_if_t<Iterator<I> && Sentinel<S, I>, iter_difference_t<I>>
    {
...
private:
    ...
    static constexpr auto impl(R&& r)
        -> detail::enable_if_t<SizedRange<R>, iter_difference_t<iterator_t<R>>>
    {
...
public:
    ...
    constexpr auto operator()(R&& r) const
        -> detail::enable_if_t<Range<R>, iter_difference_t<iterator_t<R>>>
    {
...
struct fn {
    template <typename I>
    constexpr auto operator()(I x) const -> detail::enable_if_t<Iterator<I>, I>
    {
        ++x;
        return x;
    }
    ...
    constexpr auto operator()(I x, S bound) const
        -> detail::enable_if_t<Iterator<I> && Sentinel<S, I>, I>
    {
...
struct fn {
    ...
    constexpr auto operator()(I x) const
        -> detail::enable_if_t<BidirectionalIterator<I>, I>
    {
        --x;
        return x;
    }
    ...
    template <typename I, typename S>
    constexpr auto operator()(I x, iter_difference_t<I> n, S bound) const
        -> detail::enable_if_t<BidirectionalIterator<I> && Sentinel<S, I>, I>
    {
        ranges::advance(x, -n, bound);
        return x;
    }
