...
public:
    ...
    template <typename I2, detail::enable_if_t<ConvertibleTo<I2, I>, int> = 0>
    ...
    constexpr auto operator=(const counted_iterator<I2>& i)
        -> detail::enable_if_t<ConvertibleTo<I2, I>, counted_iterator&>
    {
        current_ = i.current_;
        cnt_ = i.cnt_;
        return *this;
    ...
    template <typename II = I,
              detail::enable_if_t<detail::Dereferenceable<const II>, int> = 0>
    ...
    template <typename II = I>
    constexpr auto
    operator++(int) -> detail::enable_if_t<ForwardIterator<II>, counted_iterator>
    {
        auto tmp = *this;
        ++*this;
        return tmp;
    ...
    constexpr auto operator--()
        -> detail::enable_if_t<BidirectionalIterator<II>, counted_iterator&>
    {
        --current_;
        ++cnt_;
        return *this;
    ...
    constexpr auto operator+(difference_type n) const
        -> detail::enable_if_t<RandomAccessIterator<II>, counted_iterator>
    {
        return counted_iterator(current_ + n, cnt_ - n);
    }

    template <typename II = I, detail::enable_if_t<RandomAccessIterator<II>, int> = 0>
    ...
    template <typename II = I,
              detail::enable_if_t<RandomAccessIterator<II>, int> = 0>
    ...
    friend constexpr auto operator==(const counted_iterator& x,
        ...
        -> detail::enable_if_t<Common<I2, I>, bool>
    {
    ...
    friend constexpr auto operator-(const counted_iterator& x,
                                    const counted_iterator<I2>& y)
        -> detail::enable_if_t<Common<I2, I>, iter_difference_t<I2>>
    {
        return y.count() - x.count();
    }
    ...
    template <typename II = I, detail::enable_if_t<InputIterator<II>, int> = 0>
#endif
...
template <typename I>
struct counted_iterator_readable_traits_helper<I, detail::enable_if_t<Readable<I>>> {
...
template <typename I>
struct counted_iterator_category_helper<I, detail::enable_if_t<InputIterator<I>>> {
...
constexpr auto make_counted_iterator(I i, iter_difference_t<I> n)
    -> detail::enable_if_t<Iterator<I>, counted_iterator<I>>
{
